...
for epoch in range(start_epoch, epochs):
    ...
    for chunk_id in range(num_chunks):
        ...
        train_dataset = CustomDataset(chunk_texts, chunk_labels, tokenizer, max_len=256)
        ...
        del chunk_texts, chunk_labels, train_dataset, train_loader, loop
    ...
    # Evaluation
    val_dataset = CustomDataset(val_texts.tolist(), val_labels.values, tokenizer, max_len=256)
    ...
    del val_dataset, val_loader, all_preds, all_labels
    torch.cuda.empty_cache()
    gc.collect()
